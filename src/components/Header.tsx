      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden lg:flex items-center space-x-8 flex-1 justify-center">
            <Link href="/buy" className="text-gray-700 hover:text-[#2563EB] font-medium transition-colors">
              Buy
            </Link>
            <Link href="/rent" className="text-gray-700 hover:text-[#2563EB] font-medium transition-colors">
              Rent
            </Link>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden py-4 border-t border-gray-200">
            <div className="flex flex-col space-y-4">
              <Link href="/buy" className="text-gray-700 hover:text-[#2563EB] font-medium" onClick={() => setIsMobileMenuOpen(false)}>
                Buy
              </Link>
              <Link href="/rent" className="text-gray-700 hover:text-[#2563EB] font-medium" onClick={() => setIsMobileMenuOpen(false)}>
                Rent
              </Link>
